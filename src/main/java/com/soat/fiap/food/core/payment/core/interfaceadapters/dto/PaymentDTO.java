package com.soat.fiap.food.core.payment.core.interfaceadapters.dto;
 ...
 */
public record PaymentDTO(UUID id, String userId, Long orderId, PaymentMethod type, LocalDateTime expiresIn, String tid,
