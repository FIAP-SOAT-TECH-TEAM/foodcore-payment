...
/**
 * Steps BDD responsáveis por validar a recuperação bem-sucedida
 * do QrCode de pagamento por ID do pedido.
 * <p>
 * Executa chamadas reais HTTP contra o endpoint:
 * <pre>GET /{orderId}/qrCode</pre>
 * </p>
 */
public class QrCodeSteps extends CucumberSpringConfiguration {
	 ...
	 *
	 * @param userId ID do cliente do pedido.
	 */
	 ...
	 *
	 * @param orderId ID do pedido utilizado na URL.
	 */
	 ...
	 *
	 * @param statusCode código esperado, ex: 200.
	 */
	 ...
	 *
	 * @param campo nome do campo JSON.
	 ...
	 *
	 * @param campo nome do campo JSON esperado.
	 */
