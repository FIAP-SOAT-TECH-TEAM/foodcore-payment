...
class PaymentMethodTest {
	...
	@Test @DisplayName("Deve retornar descrição correta para cada método de pagamento")
	...
	@Test @DisplayName("Deve converter string válida para PaymentMethod correspondente")
	...
	@Test @DisplayName("Deve converter string com espaços ou hífens para PaymentMethod correspondente")
