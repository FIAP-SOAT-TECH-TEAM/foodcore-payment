package com.soat.fiap.food.core.payment.payment.unit.eventlistener;
...
import com.soat.fiap.food.core.payment.infrastructure.in.event.listener.azsvcbus.catalog.StockDebitListenerConfig;
...
class OrderEventListenerTest {
	...
	void shouldProcessOrderCreatedEventSuccessfully() {
		...
		var listener = new StockDebitListenerConfig(paymentDataSource, acquirerSource, eventPublisherSource);
