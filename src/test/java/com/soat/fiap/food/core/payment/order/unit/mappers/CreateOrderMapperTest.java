package com.soat.fiap.food.core.payment.order.unit.mappers;
...
import com.soat.fiap.food.core.payment.order.core.application.inputs.CreateOrderInput;
import com.soat.fiap.food.core.payment.order.core.application.inputs.mappers.CreateOrderMapper;
import com.soat.fiap.food.core.payment.order.core.domain.model.Order;
import com.soat.fiap.food.core.payment.order.infrastructure.in.web.api.dto.request.CreateOrderRequest;
import com.soat.fiap.food.core.payment.order.infrastructure.in.web.api.dto.request.OrderItemRequest;
import com.soat.fiap.food.core.payment.shared.core.interfaceadapters.gateways.AuthenticatedUserGateway;
import com.soat.fiap.food.core.payment.shared.fixtures.OrderFixture;
